...
class ToastNotifier(object):
    ...
    def _show_toast(self, title, msg,
        ...
        try:
            ...
            handler = self.classAtom
        except:
            self.classAtom = handler

        style = WS_OVERLAPPED | WS_SYSMENU
        name = msg[:msg.find(' triggered')]

        if name not in active_toast_list:
            active_toast_list.append(name)
            print(active_toast_list)
            ...
            nid = (self.hwnd, 0, flags, WM_USER + 20, hicon, "Alert!")
